...
public class DoctorsServiceImpl implements DoctorsService{
    ...
    @Override
    public List<Doctors> findDrByDeid(Integer deid) {
        return doctorsMapper.findDrByDeid(deid);
    }

    @Override
    public List<Doctors> findDrByDeidBdate(Integer deid, Date bdate) {
        return doctorsMapper.findDrByDeidBdate(deid,bdate);
    }

    @Override
    public DoctorsInfo findDrByDeidBdateDoid(Date bdate, Integer doid) {
        return doctorsMapper.findDrByDeidBdateDoid(bdate,doid);
    }

    @Override
    public Integer findDoid(String doname) {
        return doctorsMapper.findDoid(doname);
    }
